...
?>
                ...
                <h5 style="margin-left: 26px;color: rgb(86,1,225);margin-bottom: 18px;"><strong>Latest Announcements</strong></h5>
                <div class="container ">
                                                    ...
                                                    <div class="col col-md-11" style="height: 25%;padding-left: 8px;padding-right: 8px;">
                                                            ...
                                                            <div class="input-group " style="margin-top: 15px;">
                                                                ...
                                                                <div class="input-group-append">
                                                                    <input type="submit" class="btn btn-primary " value="SEND" name="student_announcement_reply">
                                                                </div>
                                                            </div>

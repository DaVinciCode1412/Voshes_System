...
?>
                ...
                <div class="container-fluid ">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark" style="font-family: ABeeZee, sans-serif;color: rgb(29,29,31);margin-bottom: -5px;"><strong>Guidance Counselor Section</strong></h3>
                    </div>
                </div>
                <div class="container w-75">
                    <div class="container" style="box-shadow: 0px 0px 12px rgb(133, 135, 150);border-radius: 10px;max-width: 1280px;background: #ffcceb;padding-bottom: 48px;">
                        <div class="row">
                            <div class="col-md-12">
                                <h6 style="color: rgb(18,18,18);margin-bottom: -2px;margin-top: 12px;"><strong>Write a post</strong><i class="fa fa-pencil-square-o" style="margin-left: 7px;"></i></h6>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col col-md-12" style="height: 25%;padding-left: 8px;padding-right: 8px;">
                                <form style="height: 38px;width: 100%;" action="../post_process.php" method="POST">
                                        <div class="input-group" style="height: 75.6px;">
                                            ...
                                            <div class="input-append"><input type="submit" class="h-100 btn btn-lg btn-primary" name="student_guidance_message" value="Post"></div>
                                        </div>
                                </form>
                            </div>
                        </div>
                ...
                <?php
                                        ...
                                        $sql = "select * from user_post where post_ID = $user and category ='guidance' order by dated_post desc, post_time desc ";
                                        ...
                                        <div class="card-body" style="background: #ede2ff;border-radius: 10px;height: 100%;padding-bottom: 37px;">
                                            <form action = "../reply_process.php" method = "POST">
                                                ...
                                                <div class="row" style="height: 33%;margin-top: -8px;">
                                                    <div class="col-1 col-md-1" style="height: 25%;margin-bottom: 0px;width: 25%;"><img class="rounded-circle img-fluid" alt="" src="../images/'.$row2['profile_pic'].'" style="width: 100px;margin-top: 8px;margin-bottom: 0px;margin-left: 0px;max-width: 150%;"></div>
                                                    <div class="col col-md-11" style="height: 25%;padding-left: 8px;padding-right: 8px;">
                                                            ...
                                                            <div class="input-group " style="margin-top: 15px;">
                                                                ...
                                                                <div class="input-group-append">
                                                                    <input type="submit" class="btn btn-primary " value="SEND" name="student_guidance_reply">
                                                                </div>
                                                            </div>

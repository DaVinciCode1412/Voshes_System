...
<?php
    ...
    if (isset($_POST['search'])) {
        ...
        $sql = "select * from user_info where first_name = '$fname' and last_name = '$lname' and position = 'counselor' and status = 'normal' ";
        $result = $search_con->query($sql);
    }
    else{
        $sql = "select * from user_info where position = 'counselor' and status = 'normal' order by user_id";
        $result = $search_con -> query($sql);
    }
?>
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark" style="font-family: ABeeZee, sans-serif;color: rgb(29,29,31);margin-bottom: -5px;"><strong>Guidance Section</strong></h3>
                    </div>
                </div>
                <div class="row" style="margin-left: 0px;margin-right: 0px;padding-top: 7px;">
                    <div class="input-group container" >
                        <button class="btn btn-success" data-toggle="modal" data-target="#modal1" type="button" >Add Counselor</button>
                        <div class="col">
                            <form id="form1" action="admin-users-guidance.php" method="post">
                ...
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer" style="width: 100%;background: rgb(220,228,246);">
                            <div class="form-group"><button class="btn btn-danger" type="button" data-dismiss="modal" style="margin-right: 11px;">Close</button><button class="btn btn-success" type="submit" name="guidance" style="background: rgb(46,169,80);">Save</button></div>
                        </div>
                    </div>
                </div>
            </div>

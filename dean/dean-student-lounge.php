...
?>
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark" style="font-family: ABeeZee, sans-serif;color: rgb(29,29,31);margin-bottom: -5px;"><strong>Student Lounge</strong></h3>
                    </div>
                </div>
                
                <hr style="color: rgb(62,62,64);">
                <h5 style="margin-left: 0px;color: rgb(176,83,31);margin-bottom: 24px;text-align: center;background: #f2f0f0;padding-top: 5px;padding-bottom: 5px;"><strong>Latest Concerns</strong></h5>
                <?php
                                        ...
                                        $sql = "select * from user_post where category = 'dean' order by dated_post desc";
                                            ...
                                            <form action = "../reply_process.php" method = "POST">
                                                ...
                                                <input value=" ' . $_SESSION["user_id"] . ' " name="post_id" hidden>
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <h6 style="margin-top: -7px;font-size: 12px;">' . $row["dated_post"] . '</h6>
                                                ...
                                                <div class="row" style="height: 33%;margin-top: -8px;">
                                                    <div class="col-1 col-md-1" style="height: 25%;margin-bottom: 0px;width: 25%;"><img class="rounded-circle img-fluid"  src="../images/'.$pic_row['profile_pic'].'" style="width: 100px;margin-top: 8px;margin-bottom: 0px;margin-left: 0px;max-width: 150%;"></div>

                                                    <div class="col col-md-11" style="height: 25%;">
                                                            
                                                            <div class="input-group " style="margin-top: 15px;">

                                                                <input class="form-control" type="text"placeholder="Write a reply..." name="message">
                                                                <div class="input-group-append">
                                                                    <input type="submit" class="btn btn-primary " value="SEND" name="dean_reply">
                                                                </div>
                                                            </div>
                                                     
                                                    </div>
                                                    <div class="container-fluid text-center text-light"><a class="btn btn-primary w-25" data-toggle="collapse" data-target="#d'.$row["postTbl_ID"].'">View Reply</a></div>
                                                    ';
                                                    ...
                                                    if ($result3->num_rows > 0) {
                                                        ...
                                                        $id_pic = $rowInner['reply_id'];
                                                            ...
                                                            echo ' 
                                                                    ...
                                                                    <div class="col-1 col-md-1 collapse" style="height: 25%;margin-bottom: 0px;width: 25%;" id="d'.$row["postTbl_ID"].'"><img class="rounded-circle img-fluid" alt src="../images/'.$pic_row['profile_pic'].'" style="width: 100px;margin-top: 8px;margin-bottom: 0px;margin-left: 0px;max-width: 150%;"></div>
                                                                    <div class="col col-md-11 collapse" id="d'.$row["postTbl_ID"].'" style="height: 25%;padding-left: 8px;padding-right: 8px;">
                                                                        
                                                                            <div style="margin-top: 15px; padding-left: 20px;">
                                                                                <small>' . $pic_row['first_name'] . ' '.$pic_row['last_name'].'</small><br>
                                                                                <p>'. $rowInner["message"] .'</p>

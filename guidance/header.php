    ...
    <div id="wrapper">
        <nav class="navbar navbar-dark text-nowrap align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: url(&quot;assets/img/ccnav.png&quot;) center left / cover no-repeat, rgb(0,46,88);box-shadow: 0px 0px 13px rgb(0,0,0);">
            <div class="container-fluid d-flex flex-column p-0"><?php
                                          ...
                                          ?><span style="margin-top: 6px;color: rgb(255,255,255);font-size: 24px;"><strong><?php
                    
                    echo $_SESSION['user_id'];
                ?></strong></span><span style="margin-top: 0px;color: rgb(255,255,255);font-size: 16px;"></span>
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item">
                        <hr style="margin: 8px 0px;margin-bottom: 4px;margin-top: 9px;max-width: none;margin-right: 15px;margin-left: 15px;background: #33fb01;border-radius: 50px;border-width: 2px;border-top-color: rgb(248,;border-right-color: 249,;border-bottom-width: 0px;border-bottom-color: 252);border-left-color: 249,;"><a class="nav-link" href="index.php"><i class="fa fa-bullhorn"></i><span>Announcements</span></a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="guidance-student-lounge.php"><i class="fa fa-user-circle"></i><span style="text-align: center;">Student Lounge</span></a></li>
                    <li class="nav-item"></li>
                    <li class="nav-item"><a class="nav-link" href="guidance-appointment.php"><i class="fa fa-calendar"></i><span style="text-align: center;">Appointment</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="guidance-calendar.php"><i class="fa fa-calendar"></i><span style="text-align: center;">Calendar</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="guidance-change-pass.php"><i class="fa fa-exchange"></i><span style="text-align: left;">Change Password</span></a></li>

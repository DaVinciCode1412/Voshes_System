...
?>
                ...
                <div class="container w-75">
                    <div class="container" style="box-shadow: 0px 0px 12px rgb(133, 135, 150);border-radius: 10px;background: #eee3ff;padding-bottom: 48px;">
                        <div class="row">
                            <div class="col-md-12">
                                <h6 style="color: rgb(18,18,18);margin-bottom: -2px;margin-top: 12px;"><strong>Write a post</strong><i class="fa fa-pencil-square-o" style="margin-left: 7px; padding-bottom: 10px;"></i></h6>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col col-md-12" style="height: 25%;padding-left: 8px;padding-right: 8px;">
                                <form style="height: 38px;width: 100%;" action="../post_process.php" method="POST">
                                    <div class="input-group" style="height: 75.6px;">
                                        ...
                                        <div class="input-append"><input type="submit" class="h-100 btn btn-lg btn-primary" name="student_dean_message" value="Post"></div>
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                <?php
                                        ...
                                        $sql = "select * from user_post where post_ID = $user and category ='dean' order by dated_post desc, post_time desc";
                                                    ...
                                                    <div class="col col-md-11" style="height: 25%;padding-left: 8px;padding-right: 8px;">
                                                            ...
                                                            <div class="input-group " style="margin-top: 15px;">
                                                                ...
                                                                <div class="input-group-append">
                                                                    <input type="submit" class="btn btn-primary " value="SEND" name="student_dean_reply">
                                                                </div>
                                                            </div>

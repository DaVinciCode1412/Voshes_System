                            ...
                            <div class="col col-md-12" style="height: 25%;padding-left: 8px;padding-right: 8px;">
                                <form style="height: 38px;width: 100%;" action="../post_process.php" method="POST">
                                    <div class="input-group" style="height: 75.6px;">
                                        ...
                                        <div class="input-append"><input type="submit" class="h-100 btn btn-lg btn-primary" name="dean_announcement_message" value="Post"></div>
                                    </div>
                                </form>
                            </div>
                        </div>
                                                    ...
                                                    <div class="col col-md-11" style="height: 25%;">
                                                            ...
                                                            <div class="input-group " style="margin-top: 15px;">
                                                                ...
                                                                <div class="input-group-append">
                                                                    <input type="submit" class="btn btn-primary " value="SEND" name="announcement_dean_reply">
                                                                </div>
                                                            </div>

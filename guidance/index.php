...
?>
                ...
                <div class="container w-75" style="box-shadow: 0px 0px 12px rgb(133, 135, 150);border-radius: 10px;background: #84f966;padding-bottom: 48px;">
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col col-md-12" style="height: 25%;padding-left: 8px;padding-right: 8px;">
                            <form style="height: 38px;width: 100%;" action="../post_process.php" method="POST">
                                    <div class="input-group" style="height: 75.6px;">
                                        ...
                                        <div class="input-append"><input type="submit" class="h-100 btn btn-lg btn-primary" name="guidance_announcement_message" value="Post"></div>
                                    </div>
                            </form>
                ...
                <h5 style="margin-left: 26px;color: #2a661a;margin-bottom: 18px;"><strong>Latest Announcements</strong></h5>
                <?php
                                                    ...
                                                    <div class="col col-md-11" style="height: 25%;">
                                                            ...
                                                            <div class="input-group " style="margin-top: 15px;">
                                                                ...
                                                                <div class="input-group-append">
                                                                    <input type="submit" class="btn btn-primary " value="SEND" name="announcement_guidance_reply">
                                                                </div>
                                                            </div>

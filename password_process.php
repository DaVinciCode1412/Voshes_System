<?php
	...
	if(isset($_POST['student_pass'])){
		...
		if($pass1 == $pass2){
			...
			if ($result2) {
				echo "<button id='btn' hidden onclick='student_success()'>f</button>";
			}
	...
	if(isset($_POST['guidance_pass'])){
		...
		if($pass1 == $pass2){
			...
			$result2 = $con->query($sql2);
			if ($result2) {
				echo "<button id='btn' hidden onclick='guidance_success()'>f</button>";
			}
	...
	if(isset($_POST['admin_pass'])){
		...
		if($pass1 == $pass2){
			...
			$result2 = $con->query($sql2);
			if ($result2) {
				echo "<button id='btn' hidden onclick='admin_success()'>f</button>";
			}

...
?>
                ...
                <h5 style="margin-left: 0px;color: rgb(54,136,33);margin-bottom: 24px;text-align: center;background: #f2f0f0;padding-top: 5px;padding-bottom: 5px;"><strong>Latest Concerns</strong></h5>
                <?php
                                        ...
                                        $sql = "select * from user_post where category = 'guidance' order by dated_post desc";
                                                    ...
                                                    <div class="col col-md-11" style="height: 25%;">
                                                            ...
                                                            <div class="input-group " style="margin-top: 15px;">
                                                                ...
                                                                <div class="input-group-append">
                                                                    <input type="submit" class="btn btn-primary " value="SEND" name="guidance_reply">
                                                                </div>
                                                            </div>
                                                    ...
                                                    if ($result3->num_rows > 0) {
                                                        ...
                                                        $id_pic = $rowInner['reply_id'];
                                                            ...
                                                            echo ' 
                                                                    ...
                                                                    <div class="col col-md-11 collapse" id="d'.$row["postTbl_ID"].'" style="height: 25%;">
